      ...
      <div class="d-flex" id="wrapper">
        <div class="bg-white" id="sidebar-wrapper">
          ...
          <div class="list-group list-group-flush my-3">
            ...
            .$viewtable->viewTotalLibrary(). '</span>';  ?>
            </a>
            ...
            <div class="item">
              ...
              <div class="sub-menu">
                <a href="libr-req-tr.php" name="Rtransfer" class="sub-item border-bottom" value="Transfer">
                  Transfer <?php echo '<span class="badge badge-danger">'.$viewtable->viewCountPendingLibraryTR(). '</span>';?> </a> 
                <a href="libr-req-gd.php" name="Rgraduate" class="sub-item" value="Graduate">
                  Graduate <?php echo '<span class="badge badge-danger">'.$viewtable->viewCountPendingLibraryGD(). '</span>';?> </a> 
              </div>
            </div>
            ...
            <div class="item">
              ...
              <div class="sub-menu">
                <a href="libr-app-tr.php" name="Atransfer" class="sub-item border-bottom" value="Transfer">Transfer</a>
                <a href="libr-app-gd.php" name="Agraduate" class="sub-item" value="Graduate">Graduate</a>
              </div>
            </div>
            ...
            <div class="item pb-3 border-bottom">
              ...
              <div class="sub-menu">
                <a href="libr-hld-tr.php" name="Atransfer" class="sub-item border-bottom" value="Transfer">Transfer</a>
                <a href="libr-hld-gd.php" name="Agraduate" class="sub-item" value="Graduate">Graduate</a>
              </div>
            </div>
              ...
              <ul class="navbar-nav  ms-auto mb-2 mb-lg-0">
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <li><a href="changepasswordLibrary.php" class="dropdown-item">Setting</a></li>
            ...
            <div class="row">
              <div class="col-md p-5 content">
                <?php
                  ...
                  $viewtable->viewApproveTableLibraryGraduate();
