        ...
        <div class="bg-white" id="sidebar-wrapper">
          ...
          <div class="list-group list-group-flush my-3">
            ...
            <div class="item">
              ...
              <div class="sub-menu">
                <a href="dean-req-tr.php" name="Rtransfer" class="sub-item border-bottom" value="Transfer">
                  Transfer <?php echo '<span class="badge badge-danger">'.$viewtable->viewCountPendingDeanTR(). '</span>';?> </a> 
                <a href="dean-req-gd.php" name="Rgraduate" class="sub-item" value="Graduate">
                  Graduate <?php echo '<span class="badge badge-danger">'.$viewtable->viewCountPendingDeanGD(). '</span>';?> </a> 
              </div>
            </div>
            ...
            <div class="item">
              ...
              <div class="sub-menu">
                <a href="dean-app-tr.php" name="Atransfer" class="sub-item border-bottom" value="Transfer">Transfer</a>
                <a href="dean-app-gd.php" name="Agraduate" class="sub-item" value="Graduate">Graduate</a>
              </div>
            </div>
            ...
            <div class="item pb-3 border-bottom">
              ...
              <div class="sub-menu">
                <a href="dean-hld-tr.php" name="Atransfer" class="sub-item border-bottom" value="Transfer">Transfer</a>
                <a href="dean-hld-gd.php" name="Agraduate" class="sub-item" value="Graduate">Graduate</a>
              </div>
            </div>
