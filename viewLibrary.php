        ...
        <div class="bg-white" id="sidebar-wrapper">
          ...
          <div class="list-group list-group-flush my-3">
            ...
            <div class="item">
              ...
              <div class="sub-menu">
                <a href="libr-req-tr.php" name="Rtransfer" class="sub-item border-bottom" value="Transfer">Transfer</a>
                <a href="libr-req-gd.php" name="Rgraduate" class="sub-item" value="Graduate">Graduate</a>
              </div>
            </div>
            ...
            <div class="item">
              ...
              <div class="sub-menu">
                <a href="libr-app-tr.php" name="Atransfer" class="sub-item" value="Transfer">Transfer</a>
            ...
            <div class="item pb-3 border-bottom">
              ...
              <div class="sub-menu">
                <a href="libr-hld-tr.php" name="Atransfer" class="sub-item" value="Transfer">Transfer</a>
