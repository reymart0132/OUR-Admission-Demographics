      ...
      <div class="d-flex" id="wrapper">
        <div class="bg-white" id="sidebar-wrapper">
          ...
          <div class="list-group list-group-flush my-3">
            ...
            <div class="item">
              ...
              <div class="sub-menu">
                <a href="regs-req-tr.php" name="Rtransfer" class="sub-item border-bottom" value="Transfer">Transfer</a>
                <a href="regs-req-gd.php" name="Rgraduate" class="sub-item" value="Graduate">Graduate</a>
              </div>
            </div>
            ...
            <div class="item">
              ...
              <div class="sub-menu">
                <a href="regs-app-tr.php" name="Atransfer" class="sub-item" value="Transfer">Transfer</a>
        ...
        <div id="page-content-wrapper">
          ...
          <div class="container-fluid p-5">
            <div class="row">
              <!-- <div class="button">
                <a href="registrar.php"><i class="fa fa-angle-left fa-2x mb-3 color-primary"></i></a>
              </div> -->
