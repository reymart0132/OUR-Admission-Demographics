        ...
        <div class="bg-white" id="sidebar-wrapper">
          ...
          <div class="list-group list-group-flush my-3">
            ...
            <div class="item">
              ...
              <div class="sub-menu">
                <a href="acct-req-tr.php" name="Rtransfer" class="sub-item border-bottom" value="Transfer">
                  Transfer <?php echo '<small><span class="badge badge-danger">'.$viewtable->viewCountPendingAccountingTR(). '</span></small>';?> </a> 
                <a href="acct-req-gd.php" name="Rgraduate" class="sub-item" value="Graduate">
                  Graduate <?php echo '<span class="badge badge-danger">'.$viewtable->viewCountPendingAccountingGD(). '</span>';?> </a> 
              </div>
            </div>
            ...
            <div class="item">
              ...
              <div class="sub-menu">
                <a href="acct-app-tr.php" name="Atransfer" class="sub-item border-bottom" value="Transfer">Transfer</a>
            ...
            <div class="item pb-3 border-bottom">
              ...
              <div class="sub-menu">
                <a href="acct-hld-tr.php" name="Atransfer" class="sub-item border-bottom" value="Transfer">Transfer</a>
            ...
            <div class="row">
              <div class="col-md p-5 content">
                <?php
                  ...
                  $viewtable->viewRequestTableAccountingGraduate();
